...
public class ConstantsUrl {
    ...
    public static final String  URI_CP_MIGRATIONS_LIST = "/templates/migrations";
    public static final String  URI_CP_MIGRATIONS_DETAIL = "/templates/migrations/detail";
    public static final String  URI_CP_MIGRATIONS_CREATE = "/templates/migrations/create";
